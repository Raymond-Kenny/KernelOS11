...
set this=-------------------------------------------------------------------------------- ^& echo                                Welcome to KernelOS       				       ^& echo -------------------------------------------------------------------------------- ^& echo OS: Windows 11 23H2 ^& echo Creation Date: 12/23/2023
cls
echo %this%
...
"%SYSTEMDRIVE%\KernelOS-Modules\SetUserFTA\SetUserFTA.exe" "%SYSTEMDRIVE%\KernelOS-Modules\SetUserFTA\SetUserFTAconfig.txt"
...
timeout /t 3 /nobreak >NUL 2>&1
del /F /Q "%SYSTEMDRIVE%\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\KernelOS11.bat" >NUL 2>&1
